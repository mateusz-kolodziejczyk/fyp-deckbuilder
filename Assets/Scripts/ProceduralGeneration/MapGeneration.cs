...
namespace ProceduralGeneration
{
    public class MapGeneration : MonoBehaviour
    {
        ...
        {
            var startEnc = GameObject.Instantiate(startEncounterPrefab, new(-encounterSpacing, pathSpacing, 0) , quaternion.identity);
            ...
            for (p = 0; p < nPaths; p++)
            {
                for (i = 0; i < length; i++)
                {
                    ...
                    var encounter = GameObject.Instantiate(encounterPrefab, new(i*encounterSpacing, p*pathSpacing, 0) , quaternion.identity);
            ...
            var finalEnc = GameObject.Instantiate(finalEncounterPrefab, new(i*encounterSpacing, pathSpacing, 0) , quaternion.identity);
        ...
        {
            connections[startEncounter.pos] = new();
            // Add connection from start encounter to every initial
            for (int i = 0; i < nPaths; i++)
            {
                connections[startEncounter.pos].Add(new(i, 0));
            }
            ...
            {
                connections[new(p, length - 1)] = new() {finalEncounter.pos};
            }
        }
